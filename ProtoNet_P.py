...
p = list(cnn.named_parameters())
for name, param in p[33:]:
    param.requires_grad = False

# set the fc classifier into an identity layer
cnn.fc = nn.Identity()    

# enclosing cnn into prototypical network
fsc = PrototypicalNetworks(cnn).to(DEVICE) 
...
tb_writer = SummaryWriter("tensorboard_logs/ProtoNet_P")
...
# save model
torch.save(fsc, "best_models/ProtoNet_P")
